...
/**
 * Credits for the servers go
 * to the PHP WHOIS project.
 *
 * @see https://github.com/io-developer/php-whois/blob/master/src/Iodev/Whois/Configs/module.tld.servers.json
 */
class Servers
{
    /**
     * Container for the whois servers.
     *
     * @var \Redbox\Whois\Storage|null
     */
    protected ?Storage $servers = null;
    ...
    public function __construct()
    {
        $this->servers = new Storage(
            ...
            'anz' => 'whois.nic.anz',
            'co.ao' => 'whois.reg.it.ao',
            'it.ao' => 'whois.reg.it.ao',
            'aol' => 'whois.nic.aol',
    ...
    /**
     * Resolve the whois server for a given domain
     * extension.
     *
     * @param string $ext Resolve the whois server for this extension.
     *
     * @return string|false
     */
    public function resolve(string $ext): string|false
    {
        return $this->servers->has($ext) ? $this->servers->get($ext) : false;
    }
}
