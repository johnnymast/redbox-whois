...
class SuccessfulAdapter implements AdapterInterface
{
    /**
     ...
     *
     * @return \Redbox\Whois\Tests\Transport\Adapters\SuccessfulAdapter
     */
    public function setRequest(RequestInterface $request): SuccessfulAdapter
    {
     ...
     * @return \Redbox\Whois\Tests\Transport\Adapters\SuccessfulAdapter
     */
    public function open(): SuccessfulAdapter
    {
        return $this;
    }
     ...
     * @return \Redbox\Whois\Tests\Transport\Adapters\SuccessfulAdapter
     */
    public function close(): SuccessfulAdapter
    {
        return $this;
    }
    ...
    {
        return 'This is a success response from the server.';
    }
}
