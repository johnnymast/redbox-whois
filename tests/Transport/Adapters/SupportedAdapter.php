...
class SupportedAdapter implements AdapterInterface
{
    /**
     ...
     *
     * @return \Redbox\Whois\Tests\Transport\Adapters\SupportedAdapter
     */
    public function setRequest(RequestInterface $request): SupportedAdapter
    {
     ...
     * @return \Redbox\Whois\Tests\Transport\Adapters\SupportedAdapter
     */
    public function open(): SupportedAdapter
    {
        return $this;
    }
     ...
     * @return \Redbox\Whois\Tests\Transport\Adapters\SupportedAdapter
     */
    public function close(): SupportedAdapter
    {
        return $this;
    }
