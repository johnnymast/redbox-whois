...
class FailingAdapter implements AdapterInterface
{
     ...
     *
     * @return \Redbox\Whois\Tests\Transport\Adapters\FailingAdapter
     */
    public function setRequest(RequestInterface $request): FailingAdapter
    {
     ...
     * @return \Redbox\Whois\Tests\Transport\Adapters\FailingAdapter
     */
    public function open(): FailingAdapter
    {
        return $this;
    }
     ...
     * @return \Redbox\Whois\Tests\Transport\Adapters\FailingAdapter
     */
    public function close(): FailingAdapter
    {
        return $this;
    }
